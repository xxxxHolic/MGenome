...
% name = cell(18);
name{1} = 'Mb_domain_a_1';name{2} = 'Mb_domain_a_2'; name{3} = 'Mb_domain_a_3'; name{4} = 'Mb_domain_a_4';
name{5} = 'Mb_domain_b_1';name{6} = 'Mb_domain_b_2'; name{7} = 'Mb_domain_b_3'; name{8} = 'Mb_domain_b_4';
name{9} = 'Mb_domain_c_1';name{10} = 'Mb_domain_c_2';name{11} = 'Mb_domain_c_3';name{12} = 'Mb_domain_c_4';
