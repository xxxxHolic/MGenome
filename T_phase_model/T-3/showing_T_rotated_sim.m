...
T_c_1 = 1; T_c_2 = 1; T_c_3 = 1; T_c_4 = 0;
% T_c_4 = 1;
% T_c_3 = 1;
...
% inlimt = [0.4 0.6 0.4 0.6 0.4 0.6];   % 对应 222 斑
inlimt = [0.2 0.4 0.6 0.9 0.2 0.4];   % 对应 113 斑
...
% inlimt = [0.6 0.9 -0.9 -0.6 -0.1 0.1]; % 对应 03-3 斑
%%
...
face = 90; 
rotat{1} = 'T_b_domain_1'; rotat{2} = 'T_b_domain_2'; rotat{3} = 'T_c_domain_1';
rotat{4} = 'T_c_domain_2'; 
rotat{5} = 'T_c_domain_3'; rotat{6} = 'T_a_domain_1';
%% 对应于T_1到T_2
rotatM(1,1:3) = [-0.23 0 0.23];
rotatM(2,1:3) = [0.23 0 0.23];
rotatM(3,1:3) = [0.23 0 0.23];
rotatM(4,1:3) = [-0.23 0 0.23];
rotatM(5,1:3) = [0 0 -0.23];
rotatM(6,1:3) = [0 -0.23 0];
%% 对应与T_2到T_3
% rotatM(1,1:3) = [-0.23 0 -0.23];
% rotatM(2,1:3) = [0.23 0 -0.23];
% rotatM(3,1:3) = [0.23 0 -0.23];
...
% clf;
            ...
            for kk = 1:numel(xin)
                x0 = xin(kk);y0 = yin(kk);z0 = zin(kk);r = 0.001;
                [x,y,z] = sphere;
                hold on;
